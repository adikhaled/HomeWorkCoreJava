...
public class Temperature {
	...
	public static void main(String[] args) {
		...
		int toadaysTemperature = scanner.nextInt();

		
		if(toadaysTemperature<32) {
			System.out.println("Freezing");
		}else if(toadaysTemperature<55) {
			System.out.println("Pleasant");
		}else if (toadaysTemperature<73) {
			System.out.println("Getting Warmer");
		}else if(toadaysTemperature<101) {
